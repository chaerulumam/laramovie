...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <img src="{{ " https://image.tmdb.org/t/p/w500" . $movie['poster_path'] }}" alt="Nimona" class="w-64 md:w-96">
        <div class="md:ml-24">
        ...
        <div x-data="{isOpen: false}">
            ...
            <div class="mt-12">
                <button @click="isOpen = true"
                    href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" target="_blank"
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            @if ($loop->index < 5) <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="#" id="" class="text-lg mt-2 hover:text-gray-300">{{ $cast['name'] }}</a>
...
<div class="movie-image" x-data="{isOpen: false, image: ''}">
    ...
    <div style="background-color: rgba(0, 0, 0, .5);"
        class="fixed top-0 left-0 w-full h-full items-center shadow-lg overflow-y-auto" x-show="isOpen">
        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
            <div class="bg-gray-900 rounded">
                <div class="flex justify-end pr-4 pt-2">
